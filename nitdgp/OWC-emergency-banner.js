...
// The message displayed is controlled by an admin form.

CUEmBanner = {};
CUEmBanner.lastUpdated = 'Wednesday, October 8 at 12:22 PM';
...
CUEmBanner.show_OWC_emergency_banner = function () {
	...
	if ((CUEmBanner.OWC_message.indexOf('No message') == -1) && (showBanner)) {
		...
		header.style.fontFamily = '"freight-text-pro-n4","freight-text-pro",serif';
		...
		lastUpdatedPara.style.fontFamily = '"freight-text-pro-n4","freight-text-pro",serif';
		...
		newMessage.style.fontFamily = '"freight-text-pro-n4","freight-text-pro",serif';
		...
		"#ContentBox p {margin:0 !important; padding-bottom:1em !important}"
		document.querySelector('style').textContent +=
    "@media screen and (max-width:640px) { #ContentBox {left:20% !important; width:100% !important; } #nIcon {display:none}} @media screen and (max-width:780px) {#nIcon {display:none}}" 
	document.querySelector('style').textContent +=
    "@media screen and (max-width:1024px) { #ContentBox {position:absolute !important; margin-top:100px !important;}  #ContentBox span {font-size:24px !important} #Date{float:none !important; text-align:center !important; text-align:center !important }}"
